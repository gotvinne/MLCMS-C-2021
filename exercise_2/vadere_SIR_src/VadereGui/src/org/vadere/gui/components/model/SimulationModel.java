...
public abstract class SimulationModel<T extends DefaultSimulationConfig> extends DefaultModel {
	...
	public Color getGroupColor(@NotNull final  Pedestrian ped) {
		...
		/*
		Implemented task 4.3 by selecting the color of the different pedestrians group in the SIR model.
		Infected: Red, Susceptible: Blue, Recovered: Green
		 */

		int groupId = ped.getGroupIds().getFirst(); // {0,1,2}
		switch (groupId) {
			case 0: // Infected
